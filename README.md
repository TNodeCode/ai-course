...
In this course we will teach you the basics of neural networks. Neural networks are the foundation of artificial intelligence and solve problems that have long been considered unsolvable by a computer. They can be used for image classification, precise language translation or even generating new content like text and images. But how actually can you do those things with math and a computer? This course will teach you what a neural network is, what you can do with it and how you can program your own neural network using PyTorch, a Python framework that is used by researchers and industry alike.

## Agenda

### The data

First we will have to look at the data we can feed into a neural network. As we are working with computers all our data like tables, images or text have to be transformed into a numerical format. We will talk about _vectors_, _matrices_ and _tensors_ and how we can transfer data into these formats. We will build a data loader using PyTorch which loads our data from our disk and transforms it into the numerical representation.
